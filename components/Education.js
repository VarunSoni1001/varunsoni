    ...
    <section className="bg-white text-gray-900 dark:bg-black dark:text-white">
      <div className="container max-w-6xl px-4 py-12 mx-auto">
        <div className="flex flex-col justify-center items-center mb-8 lg:mb-14">
          <h3 className="text-xl md:text-2xl font-zina lg:text-3xl xl:text-4xl 2xl:text-5xl dark:text-white">
          ...
          <br />
          <p className="text-sm md:text-base px-12 lg:px-64 lg:text-lg font-cabinet xl:text-xl 2xl:text-2xl text-gray-700 dark:text-white">
        ...
        <VerticalTimeline lineColor="#701a75">
          {education?.map((edu, index) => (
            ...
            >
              <div className="font-satoshi dark:text-white">
                <h3 className="font-bold text-fuchsia-900">{edu.degree}</h3>
                <h3 className="uppercase text-[12px] font-bold text-gray-500 mb-3 dark:text-white">
                  {edu.date}
                </h3>
